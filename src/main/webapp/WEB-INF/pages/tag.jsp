...
<html lang="en">
  ...
  <head>
    ...
    <link href="<%= basePath%>/static/media/css/font-awesome.min.css" rel="stylesheet">
    <link href="<%= basePath%>/static/media/css/bootstrap.min.css" rel="stylesheet">
    <link href="<%= basePath%>/static/media/css/templatemo-style.css" rel="stylesheet">
	<script src="<%= basePath%>/static/media/js/jquery-1.11.2.min.js"></script>
<!-- 动画css开始 -->
<!-- 以下信息与演示无关，可不必理会 -->
<style>
				...
				<c:if test="${s.index<9}">
					<div id="pic_1" onmouseover="mouseover1()" onmouseout="mouseout1()" style="position:relative; opacity: 1; transform: scale(1) translate3d(750px, 0px, 0px); perspective: 1000px; transition: all 0.5s ease-out 0ms;" class="filtr-item" data-category="2">
		                <a href="<%=path%>/weibolists?kwid=${tk.kw_id}">
		                    <img src="<%= basePath%>/static/media/images/demo/${s.index+1}.jpg" alt="" title="${s.index+1}">
...
/* $(function() {
	...
	<!-- JS -->
	<script src="<%= basePath%>/static/media/js/jquery.filterizr.js"></script>
	<!-- jQuery -->
	<script src="<%= basePath%>/static/media/js/jquery-migrate-1.2.1.min.js"></script>
	<!--  jQuery Migrate Plugin -->
	
	<script type="<%= basePath%>/static/media/text/javascript" src="js/templatemo-script.js"></script>
	<!-- Templatemo Script -->
</body>
</html>