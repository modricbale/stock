...
<head>
    ...
    <link href="<%= basePath%>/static/media/css/style-metro1.css" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">   
                                ...
                                <tr class="">
                                    ...
                                    <td> ${l.news_time}</td>
                                    <td>${l.news_type }</td>
                                    <td>${l.news_content }</td>                                  
                                    <td><a class="edit" href="">编辑</a></td>
                                    <td><a class="" href="<%=basePath %>/news_delete_by_id?id=${l.news_id }">删除</a></td>
                                </tr> 
...
<script src="<%= basePath%>/static/media/js/table-editable1.js"></script>
<script>
