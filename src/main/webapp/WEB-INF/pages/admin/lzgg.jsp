<%@page import="com.stock.pojo.*" import="java.util.*"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<% String path=request.getContextPath();
   String basePath=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
   List<Dzjy>dzjy = (List<Dzjy>)request.getAttribute("stock_all");
   List<Ggsd>ggsd = (List<Ggsd>)request.getAttribute("ggsd");
   List<Ggzjl>ggzjl = (List<Ggzjl>)request.getAttribute("ggzjl");
   List<Lzgg>lzgg = (List<Lzgg>)request.getAttribute("lzgg");
   List<Qqgg>qqgg = (List<Qqgg>)request.getAttribute("qqgg");
   List<Yjyg>yjyg = (List<Yjyg>)request.getAttribute("yjyg");
%>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    <div class="modal-content" style="height:330px;">
      <div class="modal-header" style="border:0px;">
		...
		<div class="main-container" id="main-container">
			...
			<br>
			<br>
			<h3 class="header smaller lighter blue">领涨个股</h3>							
				<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													...
													<c:forEach items="${lzgg}" var="l">
													<tr>
														<th>${l.stock_cd }</th>
														<th>${l.stock_name }</th>
														<th>${l.current_price }</th>
														<th>${l.rise_day }</th>
														<th>${l.rise_three }</th>
														<th>${l.rise_five }</th>
														<th>${l.change_day }</th>
														<th>${l.change_three }</th>
														<th>${l.change_five }</th>
														<th>${l.fluid_day }</th>
														<th>${l.fluid_three }</th>
														<th>${l.fluid_five }</th>
								...
								<script type="text/javascript">
									function find_page(){
										var a = $("#find_page").val();
										location.href="http://localhost:8080/stock/stock_back?flag=lzgg&page="+a;
									}
								
								</script>
								
								<a href="http://localhost:8080/stock/stock_back?flag=lzgg&page=<%=page_next %>" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">下一页</a>
								
								<a  style="float:right; margin-right:30px;font-size:18px;margin-top:20px">...</a>
								<a href="http://localhost:8080/stock/stock_back?flag=lzgg&page=3" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">3</a>
								<a href="http://localhost:8080/stock/stock_back?flag=lzgg&page=2" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">2</a>
								<a href="http://localhost:8080/stock/stock_back?flag=lzgg&page=1" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">1</a>
								</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
			  ...
			  var placeholder = $('#piechart-placeholder').css({'width':'85%' , 'min-height':'150px'});
			  var data = [
			 ...
			 drawPieChart(placeholder3, data);
			 /**
