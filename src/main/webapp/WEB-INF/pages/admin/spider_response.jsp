...
<% String path=request.getContextPath();
   ...
   ArrayList<HashMap<String,String>> arrayList_total = (ArrayList<HashMap<String,String>>)request.getAttribute("arrayList_total");
      ...
      <div class="modal-header" style="border:0px;">
		...
		<div class="main-container" id="main-container">
			...
			<br>
								...
								<h3 class="header smaller lighter blue">爬虫信息统计</h3>							
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													...
													<%for(int i=0;i<arrayList_total.size();i++ ){
														HashMap<String,String> hs= arrayList_total.get(i);
														%>
													<tr>
														<th><%=hs.get("project_name") %></th>
														<th><%=hs.get("spider_name") %></th>
														<th><%=hs.get("log_level") %></th>
														<th><%=hs.get("log_path") %></th>
														
														<th><%=hs.get("response_count") %></th>
														<th><%=hs.get("response_status_count_200") %></th>
														<th><%=hs.get("response_status_count_301") %></th>
														<th><%=hs.get("response_status_count_404") %></th>
														<th><%=hs.get("response_status_count_500") %></th>
														<th><%=hs.get("response_status_count_502") %></th>
														<th><%=hs.get("dupefilter_filtered") %></th>
