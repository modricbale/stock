...
<% String path=request.getContextPath();
   ...
   List<Integer>  category_list_today = (List<Integer>)request.getAttribute("category_list_today");
   List<Integer> category_list_week = (List<Integer>)request.getAttribute("category_list_week");
   List<Integer> category_list_month = (List<Integer>)request.getAttribute("category_list_month");
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				<% String[] arr = {"#2091CF","#DA5430","#68BC31",};
				 
				  %>
				  var placeholder = $('#piechart-placeholder').css({'width':'70%' , 'min-height':'150px'});
				  var data = [
				 
					{ label: "涨股统计",  data: <%=category_list_today.get(0)%>, color: "<%=arr[0]%>"},
					
					{ label: "持平",  data: <%=category_list_today.get(1)%>, color: "<%=arr[1]%>"},
					{ label: "跌股统计",  data: <%=category_list_today.get(2)%>, color: "<%=arr[2]%>"},
				  ]
			  
				  var placeholder2 = $('#piechart-placeholder2').css({'width':'70%' , 'min-height':'150px'});
				  var data2 = [
				 
					{ label: "涨股统计",  data: <%=category_list_week.get(0)%>, color: "<%=arr[0]%>"},
					
					{ label: "持平",  data: <%=category_list_week.get(1)%>, color: "<%=arr[1]%>"},
					{ label: "跌股统计",  data: <%=category_list_week.get(2)%>, color: "<%=arr[2]%>"},
				  ...
				  var data3 = [
					...
					{ label: "涨股统计",  data: <%=category_list_month.get(0)%>, color: "<%=arr[0]%>"},
					
					{ label: "持平",  data: <%=category_list_month.get(1)%>, color: "<%=arr[1]%>"},
					{ label: "跌股统计",  data: <%=category_list_month.get(2)%>, color: "<%=arr[2]%>"},
