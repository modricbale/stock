      ...
      <div class="modal-header" style="border:0px;">
		...
		<div class="main-container" id="main-container">
			...
			<br>
								...
								<h3 class="header smaller lighter blue">个股资金流</h3>							
								<div class="row">
									<div class="col-xs-12">
								...
								<script type="text/javascript">
									function find_page(){
										var a = $("#find_page").val();
										location.href="http://localhost:8080/stock/stock_back?flag=ggzjl&page="+a;
									}
								
								</script>
								
								<a href="http://localhost:8080/stock/stock_back?flag=ggzjl&page=<%=page_next %>" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">下一页</a>
								
								<a  style="float:right; margin-right:30px;font-size:18px;margin-top:20px">...</a>
								<a href="http://localhost:8080/stock/stock_back?flag=ggzjl&page=3" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">3</a>
								<a href="http://localhost:8080/stock/stock_back?flag=ggzjl&page=2" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">2</a>
								<a href="http://localhost:8080/stock/stock_back?flag=ggzjl&page=1" style="float:right; margin-right:30px;font-size:18px;margin-top:20px">1</a>
								</div>
