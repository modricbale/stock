											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													...
													<tr>
														...
														<th><%=hs.get("exception_count") %></th>
														<th><%=hs.get("TCPTimedOutError") %></th>
														<th><%=hs.get("TimeoutError") %></th>
														<th><%=hs.get("ResponseNeverReceived") %></th>
														
														<th><%=hs.get("log_count_INFO") %></th>
														<th><%=hs.get("log_count_ERROR") %></th>
													
														<th><%=hs.get("spider_exceptions_AttributeError") %></th>	
