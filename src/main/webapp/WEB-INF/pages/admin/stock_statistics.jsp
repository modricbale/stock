...
<% String path=request.getContextPath();
   ...
   HashMap<String, List<Integer>> category_hashmap =(HashMap<String, List<Integer>>) request.getAttribute("category_hashmap");
      ...
      <div class="modal-header" style="border:0px;">
		...
		<div class="main-container" id="main-container">
			...
			<br>
								...
								<h3 class="header smaller lighter blue">股票行业涨跌统计</h3>							
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													...
													<% Set set = category_hashmap.keySet();
													Iterator iter = set.iterator();
													
													for(int i=0;i<category_hashmap.size();i++){
														String key = (String)iter.next();
													%>
													<tr>
														<th><%=key %></th>
														<th><%=category_hashmap.get(key).get(0) %></th>
														<th><%=category_hashmap.get(key).get(1) %></th>
														<%if(!(category_hashmap.get(key).get(1)==0)){
															String per = ((double)category_hashmap.get(key).get(0))
																	/(category_hashmap.get(key).get(1)
																			+category_hashmap.get(key).get(0))*100+"%";%>
														<%-- <th><fmt:formatNumber value="<%=per %> "type="currency" pattern="$.00"/></th>  --%>
														<th><%=per %></th> 
														<%} %>
														<%if(category_hashmap.get(key).get(1)==0){%>
														<th>100%</th>
